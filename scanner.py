# ===== VN21 Breakout Scanner — Render edition (no Sheets) =====
import time, requests, datetime as dt
from statistics import mean
import os

BOT_TOKEN = os.environ["BOT_TOKEN"]
CHAT_ID   = os.environ["CHAT_ID"]  # ví dụ "5614513021"
...
def during_session(t: dt.datetime):
    ...
    return (540 <= hm <= 690) or (780 <= hm <= 900)  # 9:00–11:30, 13:00–15:00
...
def run_loop():
    ...
    send_tele("🚀 VN21 Scanner khởi động (Render Web Service, 5m/20s).")
